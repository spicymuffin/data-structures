...
class HTable {
	...
	public static void main(String[] args) {
		...
		ht = new HTable(3989);
		do {
			if (ht.insert(new BigInteger("2103"), "p1") != true)
				break;
			if (ht.insert(new BigInteger("2103"), "p2") != false)
				break;
			if (ht.insert(new BigInteger("2104"), "p3") != true)
				break;
			if (ht.query(new BigInteger("2105")) != null)
				break;
